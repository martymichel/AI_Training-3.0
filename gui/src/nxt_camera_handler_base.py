...
Gain20: red contribution to the blue pixel/Gain21: green contribution to the blue pixel/Gain22: blue contribution to the blue pixel"""
    ...
    def get_system_status(self):
        """Returns system status information like CPU, RAM, Disk usage, etc."""
        return self.rest_connection.get('/system')
    
    def get_system_monitor(self):
        """Returns system monitoring data (CPU, RAM, Temperature, etc.)"""
        return self.rest_connection.get('/system/monitor')
    
    def get_system_info(self):
        """Returns extended system information"""
        return self.rest_connection.get('/system/info')
    
    def get_device_status(self):
        """Returns device status and health information"""
        return self.rest_connection.get('/devicestatus')
    
    def get_temperature_info(self):
        """Returns temperature and thermal information"""
        try:
            return self.rest_connection.get('/system/temperature')
        except:
            # Fallback if specific endpoint doesn't exist
            return self.get_system_status()
    
    def get_network_info(self):
        """Returns network information including MAC address"""
        try:
            return self.rest_connection.get('/network')
        except:
            return self.get_device_info()
    
    def get_performance_stats(self):
        """Returns performance statistics including FPS"""
        try:
            return self.rest_connection.get('/statistics')
        except:
            return self.get_system_status()
